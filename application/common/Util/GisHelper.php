...
class GisHelper
{
     ...
     * @return
     */
    public static function wgs84_To_Gcj02( $lat,  $lon) {
     ...
     * */
    public static function gcj_To_wgs84( $lat,  $lon) {
     ...
     * @return
     */
    public static function bd09_To_wgs84( $bd_lat,  $bd_lon) {

        $gcj02_arr = self::bd09_To_Gcj02($bd_lat, $bd_lon);
        $map84_arr = self::gcj_To_wgs84($gcj02_arr["lat"], $gcj02_arr["lon"]);
        return $map84_arr;
    }
