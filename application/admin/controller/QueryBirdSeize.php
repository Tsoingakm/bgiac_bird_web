...
class QueryBirdSeize  extends QueryBase
{
    public function __construct()
    {
        parent::__construct();
        $this->addBread('捕鸟网记录查询');
    }

    public function index()
    {
        $this->checkPowerWeb('query_bird_seize', $this->admin['ap_codes']);
        $action = input('act');
        $where = array();
        $pageParam = array();
        ...
        \LogPageHelper::record('查看捕鸟网记录查询', 'info', $this->logOption);
