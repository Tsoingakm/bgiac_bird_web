...
class Lawn extends Common {
    ...
    public function selectForm(){
        ...
        $options[] = [
          'index_code' => 'worker',
          'options' => $this -> get_relevant_staff('work_lawn_add')
        ];
...
//            }
        ...
        $validate = Loader::validate('WorkLawn');
        if(!$validate->check($params)){
            $this->return_msg( false, $validate->getError());
        }
