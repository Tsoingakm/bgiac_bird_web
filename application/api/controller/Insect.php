...
class Insect extends Common {
    ...
    public function selectForm(){
        ...
        $options[] = [
          'index_code' => 'worker',
          'options' => $this -> get_relevant_staff('work_insect_add')
        ];
...
//            }
        ...
        $validate = Loader::validate('WorkInsect');
        if(!$validate->check($params)){
            $this->return_msg( false, $validate->getError());
        }
